    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if ($.isEmptyObject(data.detail)) {
                ...
                if (cur_period == 0 || cur_period_status == 'C')
                    cur_period++;

                if (cur_period_status == 'C' && cur_period > total_period) {
                ...
                if ((cur_period == 1 && cur_period_status == 'Z') || cur_period_status == 'C')
...
function loadPlayerAndScore(data) {
    ...
    if (cur_period_status == 'Z' || cur_period_status == 'C') {
        $('.js-submit-instant-play').each(function() {
            $(this).attr('disabled', 'disabled');
        });
...
$(document).on('click', '#js-show-change-player-modal', function (e) {
    ...
    if ((cur_period == 0 && cur_period_status == 'Z') || cur_period_status == 'C')
        $('#js-remaining-time-div').hide();
    else {
