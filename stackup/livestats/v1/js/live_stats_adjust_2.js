...
function addStatline(player, statline) {
    ...
    $('#js-statline-list').append(
        '<tr >' +
            ...
            '<td>' + player.name + '</td>' +
            '<td><input type="text" min="0" id="js-seconds' + player.id + '" class="form-control js-input js-input" data-mask="99:99" value="' + moment("2016-01-01").startOf('day').seconds(statline.seconds).format('mm:ss') + '"></td>' +
            '<td><input type="number" min="0" id="js-trey-m' + player.id + '" class="form-control js-input" value="' + statline.trey_m + '"></td>' +
            '<td><input type="number" min="0" id="js-trey-a' + player.id + '" class="form-control js-input" value="' + statline.trey_a + '"></td>' +
            '<td><input type="number" min="0" id="js-two-m' + player.id + '" class="form-control js-input" value="' + statline.two_m + '"></td>' +
            '<td><input type="number" min="0" id="js-two-a' + player.id + '" class="form-control js-input" value="' + statline.two_a + '"></td>' +
            '<td><input type="number" min="0" id="js-ft-m' + player.id + '" class="form-control js-input" value="' + statline.ft_m + '"></td>' +
            '<td><input type="number" min="0" id="js-ft-a' + player.id + '" class="form-control js-input" value="' + statline.ft_a + '"></td>' +
            '<td style="background: #000; color: #fff">' + statline.points + '</td>' +
            '<td><input type="number" min="0" id="js-reb-o' + player.id + '" class="form-control js-input" value="' + statline.reb_o + '"></td>' +
            '<td><input type="number" min="0" id="js-reb-d' + player.id + '" class="form-control js-input" value="' + statline.reb_d + '"></td>' +
            '<td style="background: #000; color: #fff">' + (statline.reb_d + statline.reb_o) + '</td>' +
            '<td><input type="number" min="0" id="js-ast' + player.id + '" class="form-control js-input" value="' + statline.ast + '"></td>' +
            '<td><input type="number" min="0" id="js-stl' + player.id + '" class="form-control js-input" value="' + statline.stl + '"></td>' +
            '<td><input type="number" min="0" id="js-blk' + player.id + '" class="form-control js-input" value="' + statline.blk + '"></td>' +
            '<td><input type="number" min="0" id="js-turnover' + player.id + '" class="form-control js-input" value="' + statline.turnover + '"></td>' +
            '<td><input type="number" min="0" id="js-pfoul' + player.id + '" class="form-control js-input" value="' + statline.pfoul + '"></td>' +
