    ...
    success: function (result) {
        ...
        result.forEach(function(team){
            ...
            $('#js-team-list').append(
                ...
                '<td><input id="js-team-name' + team.id + '" type="text" name="name" value="' + (inputs.hasOwnProperty("name") ? inputs.name : '') + '"></td>' +
                '<td><input id="js-team-name-alt' + team.id + '" type="text" name="name_alt" value="' + (inputs.hasOwnProperty("name_alt") ? inputs.name_alt : '') + '"></td>' +
                '<td><input id="js-team-name-abbrv' + team.id + '" type="text" name="name_abbrv" value="' + (inputs.hasOwnProperty("name_abbrv") ? inputs.name_abbrv : '') + '"></td>' +
                '<td><input id="js-team-city' + team.id + '" type="text" name="city" value="' + (inputs.hasOwnProperty("city") ? inputs.city : '') + '"></td>' +
                '<td><input id="js-team-country' + team.id + '" type="text" name="country" value="' + (inputs.hasOwnProperty("country") ? inputs.country : '') + '"></td>' +
                '<td><input id="js-team-division' + team.id + '" type="text" name="division" value="' + (inputs.hasOwnProperty("division") ? inputs.division : '') + '"></td>' +
                '<td><input id="js-team-uniqueid' + team.id + '" type="text" name="uniqueid" value="' + (inputs.hasOwnProperty("uniqueid") ? inputs.uniqueid : '') + '"></td>' +
    ...
    $.ajax({
        ...
        success: function (team) {
            ...
            $('#js-team-list').append(
                ...
                '</tr>' +
                '<tr id="js-team-form' + team.id + '" style="display: none">' +
                '<td><input id="js-team-name' + team.id + '" type="text" name="name" value="' + team.detail.inputs.name + '"></td>' +
                '<td><input id="js-team-name-alt' + team.id + '" type="text" name="name_alt" value="' + team.detail.inputs.name_alt + '"></td>' +
                '<td><input id="js-team-name-abbrv' + team.id + '" type="text" name="name_abbrv" value="' + team.detail.inputs.name_abbrv + '"></td>' +
                '<td><input id="js-team-city' + team.id + '" type="text" name="city" value="' + team.detail.inputs.city + '"></td>' +
                '<td><input id="js-team-country' + team.id + '" type="text" name="country" value="' + team.detail.inputs.country + '"></td>' +
                '<td><input id="js-team-division' + team.id + '" type="text" name="division" value="' + team.detail.inputs.division + '"></td>' +
                '<td><input id="js-team-uniqueid' + team.id + '" type="text" name="uniqueid" value="' + team.detail.inputs.uniqueid + '"></td>' +
                '<td><button class="js-update btn-xs btn-success btn-fill" data-id="' + team.id + '">SAVE</button></td>' +
                '</tr>'
            );
