    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $('#js-roster-list').append(
                ...
                '</tr>' +
                '<tr id="js-roster-form' + roster.id + '" style="display: none">' +
                '<td><input id="js-roster-jersey' + roster.id + '" type="text" class="form-control input-sm" name="jersey" maxlength="2" size="2" value = "' + result.jersey + '"></td>' +
                '<td>' + $('#js-roster-position').clone().attr('id', 'js-roster-position' + roster.id)[0].outerHTML + '</td>' +
                '<td><input id="js-roster-uniqueid' + roster.id + '" type="text" class="form-control input-sm" name="uniqueid" maxlength="12" size="12" value = "' + result.uniqueid + '"></td>' +
